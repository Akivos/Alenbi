...
res1 = Residents("Dalik", "Oslander", 46, "Movies")
res2 = Residents("Shlomi", "Mizrahi", 38, "Singing")
res3 = Residents("Nahum", "Cohen", 48, "Enjoy the moment")

class Residents_test(unittest.TestCase):
	...
	def test_age(self):
		self.assertEqual(self.res1.age, 46)
	...
	def test_last(self):
		...
		self.assertEqual(self.res3.hobby, "Enjoy the moment")
